...
uint8_t SX1276_Init(uint8_t syncword, uint16_t preamblelength){
	...
	result &= SX1276_Write_Register(REG_OP_MODE, 0b10001000); // 0x84 Turn on LoRa mode and set low frequency mode
	DEBUG_PRINT("Enabling LoRa Mode\n\r");
	result &= SX1276_Set_Mode(STDBY); //go to standby mode
	result &= SX1276_Write_Register(REG_PA_CONFIG, 0b11001111); //0xCF use PA_BOOST pin
